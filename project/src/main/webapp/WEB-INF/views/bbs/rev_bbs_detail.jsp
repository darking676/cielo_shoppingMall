...
<!-- 										</div> -->
						...
						<form id="addCommentForm" action="/shop01/rev_bbs_detail/commentAdd/" method="post">
...
<%-- 					</c:forEach> --%>
		...
		<div id="form-group" style="display: none;">
			...
			<form id="modifyForm" action="/shop01/rev_bbs_edit/" method="get">
				<p>
			...
			<form id="deleteForm" action="/shop01/rev_bbs_delete/" method="get">
				<p>
					<input type="hidden" name="bbseditno" value="${param.bbseditno }" />
					<input type="hidden" name="bbscd" value="${param.bbscd }" /> <input
						type="hidden" name="curPage" value="${param.curPage }" /> <input
