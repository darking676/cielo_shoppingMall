					...
					<c:forEach items="${list }" var="bbsVo" varStatus="status">
						<tr>
							...
							<td align="right" style="text-align: right; width: 600px;"><a
								href="javascript:goView('${bbsVo.bbseditno }')">${bbsVo.title }</a>
...
<!-- 	</div> -->
	...
	<nav aria-label="Page navigation" style="padding-left: 600px;">
		<ul class="pagination">
			...
			<li><a href="/shop01/not_bbs/?bbscd=notice&curPage=1">1</a></li>
			<li><a href="/shop01/not_bbs/?bbscd=notice&curPage=2">2</a></li>
			<li><a href="/shop01/not_bbs/?bbscd=notice&curPage=3">3</a></li>
			<li><a href="/shop01/not_bbs/?bbscd=notice&curPage=4">4</a></li>
			<li><a href="/shop01/not_bbs/?bbscd=notice&curPage=5">5</a></li>
			<li><a href="/shop01/not_bbs/?bbscd=notice&curPage=6">6</a></li>
			<li><a href="/shop01/not_bbs/?bbscd=notice&curPage=7">7</a></li>
