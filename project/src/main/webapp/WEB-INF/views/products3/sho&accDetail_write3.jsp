		...
		<div id="wrap">
			...
			<div id="container">
				<div id="content" style="min-height: 800px;">
					...
					<hr class="line">
					<div id="outer">
						<form id="writeForm" action="/shop01/shoeacc_write3/" method="post"
							...
							<table id="write-form">
								<tr>
									<td>상품이름</td>
									<td><input type="text" name="productName" size="71"
										style="height: 40px;" /></td>
								</tr>
								<tr>
									<td>상품번호</td>
									<td><input type="text" name="productNum" size="71"
										style="height: 40px;" /></td>
								</tr>
								<tr>
									<td>가격</td>
									<td><input type="text" name="price" size="71"
										style="height: 40px;" /></td>
								</tr>
								<tr>
									<td>썸네일</td>
									<td><input type="text" name="product_url" size="
										71" style="height: 40px;" /></td>
								</tr>
								<tr>
									<td>&nbsp;</td>
								</tr>
