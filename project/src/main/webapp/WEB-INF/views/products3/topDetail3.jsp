...
<!-- 							</p> -->
	...
	<div id="search" style="text-align: center; margin-left: 1317px;">
		<form id="searchForm" action="/shop01/top3/" method="get"
	...
	<nav aria-label="Page navigation" style="padding-left: 600px;">
		<ul class="pagination">
			<li><a href="/shop01/top3/?procd=top&curPage=1"
				aria-label="Previous"> <span aria-hidden="true">&laquo;</span>
			</a></li>
			<li><a href="/shop01/top3/?procd=top&curPage=1">1</a></li>
			<li><a href="/shop01/top3/?procd=top&curPage=2">2</a></li>
			<li><a href="/shop01/top3/?procd=top&curPage=3">3</a></li>
			<li><a href="/shop01/top3/?procd=top&curPage=4">4</a></li>
			<li><a href="/shop01/top3/?procd=top&curPage=5">5</a></li>
			<li><a href="/shop01/top3/?procd=top&curPage=6">6</a></li>
			<li><a href="/shop01/top3/?procd=top&curPage=7">7</a></li>
			<li><a href="/shop01/top3/?procd=top&curPage=8">8</a></li>
			<li><a href="/shop01/top3/?procd=top&curPage=9">9</a></li>
			<li><a href="/shop01/top3/?procd=top&curPage=10">10</a></li>
						<li><a href="/shop01/top3/?procd=top&curPage=11" 
	...
	<div id="form-group" style="display: none;">
		<form id="listForm" action="/shop01/top3/" method="get">
			<p>
				<input type="hidden" name="procd" value="${procd }" /> <input
		...
		<form id="writeForm" action="/shop01/top_write3/" method="get">
			<p>
				<input type="hidden" name="procd" value="${procd }" /> <input
		...
		<form id="viewForm" action="/shop01/top_detail3/" method="get">
			<p>
