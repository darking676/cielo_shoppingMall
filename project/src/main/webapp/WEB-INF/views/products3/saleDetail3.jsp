...
<!-- 							</p> -->
	...
	<div id="search" style="text-align: center; margin-left: 1317px;">
		<form id="searchForm" action="/shop01/sale3/" method="get"
	...
	<nav aria-label="Page navigation" style="padding-left: 600px;">
		<ul class="pagination">
			<li><a href="/shop01/sale3/?procd=sale&curPage=1"
				aria-label="Previous"> <span aria-hidden="true">&laquo;</span>
			</a></li>
			<li><a href="/shop01/sale3/?procd=sale&curPage=1">1</a></li>
			<li><a href="/shop01/sale3/?procd=sale&curPage=2">2</a></li>
			<li><a href="/shop01/sale3/?procd=sale&curPage=3">3</a></li>
			<li><a href="/shop01/sale3/?procd=sale&curPage=4">4</a></li>
			<li><a href="/shop01/sale3/?procd=sale&curPage=5">5</a></li>
			<li><a href="/shop01/sale3/?procd=sale&curPage=6">6</a></li>
			<li><a href="/shop01/sale3/?procd=sale&curPage=7">7</a></li>
			<li><a href="/shop01/sale3/?procd=sale&curPage=8">8</a></li>
			<li><a href="/shop01/sale3/?procd=sale&curPage=9">9</a></li>
			<li><a href="/shop01/sale3/?procd=sale&curPage=10">10</a></li>
						<li><a href="/shop01/sale3/?procd=sale&curPage=11" 
	...
	<div id="form-group" style="display: none;">
		<form id="listForm" action="/shop01/sale3/" method="get">
			<p>
				<input type="hidden" name="procd" value="${procd }" /> <input
		...
		<form id="writeForm" action="/shop01/sale_write3/" method="get">
			<p>
				<input type="hidden" name="procd" value="${procd }" /> <input
		...
		<form id="viewForm" action="/shop01/sale_detail3/" method="get">
			<p>
