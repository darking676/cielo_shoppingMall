...
<!--       <p style="font-size: 23">CIELO</p> -->
    ...
    <br/>
	   ...
	   <li><a href="login/mypage">MyPage</a></li> 
	   <li><a href="login/cart">Cart</a></li> 
      </ul>
  </div>
</nav>
...
<div id="page-wrapper">
  ...
  <div class="carousel-inner" role="listbox">
    <div class="item active">
      <img id="image" src="resources/imgs/main.jpg" alt="..." width="100%" />
    </div>
    <div class="item">
      <img id="image" src="resources/imgs/img02.jpg" alt="..." width="100%" />
    </div>
     <div class="item">
      <img id="image" src="resources/imgs/img03.jpg" alt="..." width="100%" />
    </div>
  </div>
