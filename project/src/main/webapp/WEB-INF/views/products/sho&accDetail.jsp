...
<!-- 	</div> -->
	...
	<div id="search" style="text-align: center; margin-left: 1317px;">
		<form id="searchForm" action="/shop01/shoacc/" method="get"
	...
	<nav aria-label="Page navigation" style="padding-left: 600px;">
		<ul class="pagination">
			<li><a href="/shop01/shoacc/?procd=shoesNacc&curPage=1"
				aria-label="Previous"> <span aria-hidden="true">&laquo;</span>
			</a></li>
			<li><a href="/shop01/shoacc/?procd=shoesNacc&curPage=1">1</a></li>
			<li><a href="/shop01/shoacc/?procd=shoesNacc&curPage=2">2</a></li>
			<li><a href="/shop01/shoacc/?procd=shoesNacc&curPage=3">3</a></li>
			<li><a href="/shop01/shoacc/?procd=shoesNacc&curPage=4">4</a></li>
			<li><a href="/shop01/shoacc/?procd=shoesNacc&curPage=5">5</a></li>
			<li><a href="/shop01/shoacc/?procd=shoesNacc&curPage=6">6</a></li>
			<li><a href="/shop01/shoacc/?procd=shoesNacc&curPage=7">7</a></li>
			<li><a href="/shop01/shoacc/?procd=shoesNacc&curPage=8">8</a></li>
			<li><a href="/shop01/shoacc/?procd=shoesNacc&curPage=9">9</a></li>
			<li><a href="/shop01/shoacc/?procd=shoesNacc&curPage=10">10</a></li>
						<li><a href="/shop01/shoacc/?procd=shoesNacc&curPage=11" 
	...
	<div id="form-group" style="display: none;">
		<form id="listForm" action="/shop01/shoacc/" method="get">
			<p>
				<input type="hidden" name="procd" value="${procd }" /> <input
		...
		<form id="writeForm" action="/shop01/shoacc_write/" method="get">
			<p>
				<input type="hidden" name="procd" value="${procd }" /> <input
		...
		<form id="viewForm" action="/shop01/shoacc_detail/" method="get">
			<p>
