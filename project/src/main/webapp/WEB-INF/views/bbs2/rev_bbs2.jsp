...
<body>
	...
	<nav aria-label="Page navigation" style="padding-left: 800px;">
		<ul class="pagination">
			<li><a href="/shop01/rev_bbs2/?bbscd=rev_bbs&curPage=1"
				aria-label="Previous"> <span aria-hidden="true">&laquo;</span>
			</a></li>
			<li><a href="/shop01/rev_bbs2/?bbscd=review&curPage=1">1</a></li>
			<li><a href="/shop01/rev_bbs2/?bbscd=review&curPage=2">2</a></li>
			<li><a href="/shop01/rev_bbs2/?bbscd=review&curPage=3">3</a></li>
			<li><a href="/shop01/rev_bbs2/?bbscd=review&curPage=4">4</a></li>
			<li><a href="/shop01/rev_bbs2/?bbscd=review&curPage=5">5</a></li>
			<li><a href="/shop01/rev_bbs2/?bbscd=review&curPage=6">6</a></li>
			<li><a href="/shop01/rev_bbs2/?bbscd=review&curPage=7">7</a></li>
			<li><a href="/shop01/rev_bbs2/?bbscd=review&curPage=8">8</a></li>
			<li><a href="/shop01/rev_bbs2/?bbscd=review&curPage=9">9</a></li>
			<li><a href="/shop01/rev_bbs2/?bbscd=review&curPage=10">10</a></li>
...
<!-- 	</div> -->
     ...
     <form id="searchForm" action="/shop01/rev_bbs2/" method="get" style="margin: 0;padding: 0;">
	...
	<div id="form-group" style="display: none;">
		<form id="listForm" action="/shop01/rev_bbs2/" method="get">
			<p>
		...
		<form id="writeForm" action="/shop01/rev_bbs_write2/" method="get">
			<p>
				<input type="hidden" name="bbscd" value="${bbscd }" /> <input
		...
		<form id="viewForm" action="/shop01/rev_bbs_detail2/" method="get">
			<p>
