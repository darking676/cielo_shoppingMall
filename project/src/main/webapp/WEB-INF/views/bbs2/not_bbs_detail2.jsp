			...
			<div id="container">
				<div id="content" style="min-height: 800px;">
					...
					<div id="bbs">
						...
						<form id="addCommentForm" action="/shop01/not_bbs_detail2/commentAdd/" method="post">
...
<%-- 					</c:forEach> --%>
		...
		<div id="form-group" style="display: none;">
			...
			<form id="modifyForm" action="/shop01/not_bbs_edit2/" method="get">
				<p>
			...
			<form id="deleteForm" action="/shop01/not_bbs_delete2/" method="get">
				<p>
					<input type="hidden" name="bbseditno" value="${param.bbseditno }" />
					<input type="hidden" name="bbscd" value="${param.bbscd }" /> <input
						type="hidden" name="curPage" value="${param.curPage }" /> <input
			...
			<form id="deleteCommentForm" action="/shop01/not_bbs_detail2/commentDel" method="post">
				<p>
