		...
		<div id="wrap">
			...
			<div id="container">
				<div id="content" style="min-height: 800px;">
					...
					<hr class="line">
					<div id="bbs">
						<form id="modifyForm" action="/shop01/rev_bbs_edit3/" method="post"
							enctype="multipart/form-data" onsubmit="return check()">
							<p style="margin: 0; padding: 0;">
								<input type="hidden" name="bbseditno"
									value="${param.bbseditno }" /> <input type="hidden"
									name="bbscd" value="${param.bbscd }" />
							</p>
							<table id="write-form">
								<tr>
									<td>제목</td>
									<td><input type="text" name="title" size="71"
										style="height: 40px;" value="${thisBbsVo.title }" /></td>
								</tr>
								...
								<tr>
									<td colspan="2"><textarea name="contents" rows="20"
											style="width: 653px">${thisBbsVo.contents }</textarea></td>
								</tr>
								<tr>
									<td>파일첨부</td>
