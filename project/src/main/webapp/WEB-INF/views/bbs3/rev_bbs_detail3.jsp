...
<body>
	...
	<div class="location01">
			...
			<div id="container">
				<div id="content" style="min-height: 800px;">
					...
					<div id="bbs">
						...
						<form id="addCommentForm" action="/shop01/rev_bbs_detail3/commentAdd/" method="post">
		...
		<div id="form-group" style="display: none;">
			...
			<form id="modifyForm" action="/shop01/rev_bbs_edit3/" method="get">
				<p>
			...
			<form id="deleteForm" action="/shop01/rev_bbs_delete3/" method="get">
				<p>
					<input type="hidden" name="bbseditno" value="${param.bbseditno }" />
					<input type="hidden" name="bbscd" value="${param.bbscd }" /> <input
						type="hidden" name="curPage" value="${param.curPage }" />
			...
			<form id="deleteCommentForm" action="/shop01/rev_bbs_detail3/commentDel" method="post">
				<p>
