...
<hr class="line">
<div id="bbs">
<form id="modifyForm" action="/shop01/not_bbs_edit3/" method="post" onsubmit="return check()">
...
<tr>
    <td>제목</td>
    <td><input type="text" name="title" size="71" style="height: 40px;" value="${thisBbsVo.title }"/></td>
</tr>
